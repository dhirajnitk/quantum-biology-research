...
\begin{table*}[htbp]
\caption{Structural properties of Trp networks in 20 proteins. ``Coupled pairs'' have $R < 1.5$~nm; ``relay pairs'' have $1.5 \leq R \leq 5$~nm. Two targets (6J4K, 6Z0C) lacked sufficient Trp density for analysis. Human brain proteins are marked with $\dagger$. Pair counts near the $1.5$~nm cutoff have an estimated $\pm 0.3$~nm boundary uncertainty due to side-chain rotamers; for targets with asymmetric distance distributions near the cutoff, the resulting uncertainty range is reported as asymmetric (e.g., Rhodopsin $28^{+3}_{-11}$). The uncertainties on coupled and relay pairs are anti-correlated: a pair that crosses the $1.5$~nm boundary in one direction changes the coupled count by $\pm1$ and the relay count by $\mp1$, conserving the total $\binom{N}{2}$ pair sum.}
...
\midrule
7TYO & NMDA receptor GluN1/GluN2A & Human brain$\dagger$ & 23 & $21\pm9$ & $115\pm9$ \\
6CNO & NMDA receptor GluN1/GluN2B & Human brain$\dagger$ & 10 & $5\pm4$ & $30\pm4$ \\
6V2W & GABA$_A$ receptor & Human brain$\dagger$ & 7 & $2\pm1$ & $14\pm1$ \\
7KOX & $\alpha$7 nicotinic AChR & Human brain$\dagger$ & 12 & $4^{+8}_{-4}$ & $34\pm8$ \\
6PLL & Glycine receptor & Human brain$\dagger$ & 3 & $3^{+0}_{-1}$ & $0^{+1}_{0}$ \\
7T6L & $\mu$-opioid receptor & Human brain$\dagger$ & 10 & $5\pm1$ & $35\pm1$ \\
7EIX & TRPV1 ion channel & Human (sensory)$\dagger$ & 11 & $7\pm5$ & $47\pm5$ \\
7RJK & Aquaporin-4 & Human brain (glial)$\dagger$ & 3 & $1\pm1$ & $2\pm1$ \\
\addlinespace
6PV7 & nACh receptor & \emph{T. marmorata} (electric ray) & 26 & $22\pm11$ & $127\pm11$ \\
6LQA & Na$_V$1.4 sodium channel & Human (skeletal muscle) & 25 & $18\pm10$ & $150\pm10$ \\
6J8J & Na$_V$1.4 (alt. conform.) & Human (skeletal muscle) & 27 & $20\pm10$ & $141\pm10$ \\
1YAG & SNARE complex & Rat (neural) & 6 & $3\pm2$ & $12\pm2$ \\
7SQS & AMPA receptor GluA2 & Rat (neural) & 7 & $4\pm3$ & $17\pm3$ \\
7S6M & K$_V$1.2 potassium channel & Rat (neural) & 11 & $2\pm2$ & $26\pm2$ \\
1JFF & Tubulin $\alpha\beta$ dimer & Porcine (ubiquitous) & 5 & $1\pm1$ & $7\pm1$ \\
3N2K & Tubulin $\alpha\beta$ dimer & Mammalian (ubiquitous) & 5 & $1\pm1$ & $7\pm1$ \\
1BL8 & KcsA K$^+$ channel & Bacterial & 5 & $3\pm1$ & $7\pm1$ \\
6N5B & Rhodopsin & Bovine (retinal) & 17 & $28^{+3}_{-11}$ & $76\pm11$ \\
...
We subjected the five most densely packed Trp residues in each target to the Klyachko-Can-Klyachko-Shumovsky (KCKAS) contextuality test~\cite{KCKAS2008}, using a coherence-factor heuristic ($F_{\mathrm{coh}}$) derived from the ratio of off-diagonal to diagonal Hamiltonian matrix elements. This produces a KCKAS-coherence score $S = 2F_{\mathrm{coh}}$ that ranges from $0$ to a classical bound $S = 2$ (maximal coherence).
...
\begin{table*}[htbp]
\caption{KCKAS-coherence scores for static PDB geometry using the heuristic $S = 2F_{\mathrm{coh}}$, which is bounded by $S \leq 2$. $N_{\mathrm{Trp}}$ is the total Trp count per structure (the five most densely packed residues were selected for the KCKAS 3D subspace projection).}
\label{tab:kckas}
\centering
\begin{tabular}{lcccc}
\toprule
...
\item \textbf{FRET regime constraints:} The structural bounds for non-radiative transfer are quantified, including the sub-$1.5$~nm coupling threshold and coherent hopping timescale.
\end{enumerate}
...
The KCKAS sum is $S = 2 F_{\mathrm{coh}}$.
