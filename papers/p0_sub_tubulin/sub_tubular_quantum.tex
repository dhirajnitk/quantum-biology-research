...
\item \textbf{Hypothetical channel constraints:} The structural and thermodynamic bounds for any proposed mechanism are quantified, including ensemble size, per-core probability, and hopping timescale under the assumed coupling scenario.
\end{enumerate}
